...
HY2_PASSWORD="${HY2_PASSWORD:-goddoussoppp.HY2.Password}"

curl -sSL -o app.js https://raw.githubusercontent.com/goddoussoppp/one-node/refs/heads/main/lunes-host/app.js
curl -sSL -o package.json https://raw.githubusercontent.com/goddoussoppp/one-node/refs/heads/main/lunes-host/package.json
...
mv xray xy
curl -sSL -o config.json https://raw.githubusercontent.com/goddoussoppp/one-node/refs/heads/main/lunes-host/xray-config.json
...
curl -sSL -o config.yaml https://raw.githubusercontent.com/goddoussoppp/one-node/refs/heads/main/lunes-host/hysteria-config.yaml
...
echo "============================================================"
echo "♻️ VLESS Reality & HY2 Node Info"
echo "------------------------------------------------------------"
echo "$vlessUrl"
echo "$hy2Url"
echo "============================================================"
